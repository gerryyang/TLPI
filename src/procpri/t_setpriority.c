...
/*
output:
gerryyang@mba:procpri$./t_setpriority 
Usage: ./t_setpriority {p|g|u} who priority
    set priority of: p=process; g=process group; u=processes for user
gerryyang@mba:procpri$./t_setpriority p 0 0
Nice value = 0
gerryyang@mba:procpri$./t_setpriority p 0 -10
ERROR [EACCES Permission denied] setpriority
gerryyang@mba:procpri$./t_setpriority p 0 1
Nice value = 1
gerryyang@mba:procpri$./t_setpriority p 0 19
Nice value = 19
gerryyang@mba:procpri$./t_setpriority p 0 20
Nice value = 20
gerryyang@mba:procpri$./t_setpriority p 0 21
Nice value = 20
gerryyang@mba:procpri$./t_setpriority p 0 22
Nice value = 20
 */
