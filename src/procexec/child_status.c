...
/*
output:
gerryyang@mba:procexec$./child_status 
Child started with PID = 596
waitpid() returned: PID=596; status=0x117f (17,127)
child stopped by signal 17 (Suspended (signal): 17)


waitpid() returned: PID=596; status=0x0006 (0,6)
child killed by signal 6 (Abort trap: 6)
gerryyang@mba:procexec$ulimit -c unlimited
gerryyang@mba:procexec$./child_status 
Child started with PID = 641
waitpid() returned: PID=641; status=0x0086 (0,134)
child killed by signal 6 (Abort trap: 6) (core dumped)
gerryyang@mba:procexec$
gerryyang@mba:procexec$./child_status 3
Child started with PID = 638
waitpid() returned: PID=638; status=0x0300 (3,0)
child exited, status=3
 */
