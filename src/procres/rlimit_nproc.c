...
/*
output:
gerryyang@mba:procres$ps xu|wc -l
127
gerryyang@mba:procres$./rlimit_nproc 128 300
Initial maximum process limits:  soft=709; hard=1064
New maximum process limits:      soft=128; hard=300
Child 1 (PID=24089) started
Child 2 (PID=24090) started
Child 3 (PID=24091) started
ERROR [EDEADLK/EDEADLOCK Resource temporarily unavailable] fork
 */
