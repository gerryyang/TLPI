...
/*
output:
gerryyang@mba:dirs_links$touch gerry
gerryyang@mba:dirs_links$ln -s gerry gerry2
gerryyang@mba:dirs_links$./view_symlink gerry
ERROR: gerry is not a symbolic link
gerryyang@mba:dirs_links$./view_symlink gerry2
readlink: gerry2 --> gerry
realpath: gerry2 --> /Users/gerryyang/github_project/TLPI/src/dirs_links/gerry
gerryyang@mba:dirs_links$rm gerry
gerryyang@mba:dirs_links$./view_symlink gerry2
readlink: gerry2 --> gerry
