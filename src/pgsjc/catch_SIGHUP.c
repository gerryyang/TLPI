...
测试方法：执行完命令后关闭终端
output:
gerryyang@mba:pgsjc$cat samegroup.log 
PID=680; PPID=514; PGID=680; SID=513
PID=681; PPID=680; PGID=680; SID=513
680: caught SIGHUP
681: caught SIGHUP
gerryyang@mba:pgsjc$cat diffgroup.log 
PID=714; PPID=651; PGID=714; SID=650
PID=715; PPID=714; PGID=715; SID=650
714: caught SIGHUP
 */
