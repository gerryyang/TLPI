...
/*
output:
gerryyang@mba:pgsjc$cat disconnect_SIGHUP.log 
PID of parent process is:       866
Foreground process group ID is: 866
PID=866 PGID=866
PID=867 PGID=867
PID=868 PGID=866
PID=869 PGID=866
PID 869: caught signal  1 (Hangup: 1)
PID 868: caught signal  1 (Hangup: 1)
 */
